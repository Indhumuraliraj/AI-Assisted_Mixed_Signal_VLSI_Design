module design_mux (CSB,
 ...
 sky130_fd_sc_hd__inv_2 _254_ (.A(_108_),
    .Y(_109_));
 sky130_fd_sc_hd__mux2_1 _255_ (.A0(\raven_spi.U1.addr[1] ),
 ...
 sky130_fd_sc_hd__and2_1 _268_ (.A(\raven_spi.U1.wrstb ),
    .B(_120_),
    .X(_121_));
 sky130_fd_sc_hd__buf_2 _269_ (.A(_121_),
    .X(_122_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _295_ (.A(_137_),
    .X(_088_));
 sky130_fd_sc_hd__buf_2 _296_ (.A(_101_),
    .X(_138_));
 ...
 sky130_fd_sc_hd__a221o_1 _358_ (.A1(_141_),
    ...
    .C1(_180_),
    .X(_189_));
 sky130_fd_sc_hd__a21oi_1 _359_ (.A1(\raven_spi.U1.fixed[0] ),
    .A2(_141_),
    .B1(_189_),
    .Y(_190_));
 ...
 sky130_fd_sc_hd__and2_1 _391_ (.A(\raven_spi.U1.readmode ),
    .B(\raven_spi.U1.state[1] ),
    .X(_209_));
 sky130_fd_sc_hd__clkbuf_2 _392_ (.A(_209_),
    .X(_210_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _502_ (.CLK(_021_),
    ...
    .RESET_B(_020_),
    .Q(\raven_spi.SDO ));
 sky130_fd_sc_hd__dfrtp_1 _503_ (.CLK(_023_),
    .D(_066_),
    .RESET_B(_022_),
 ...
 sky130_fd_sc_hd__dfrtp_1 _515_ (.CLK(net14),
    ...
    .RESET_B(_035_),
    .Q(\raven_spi.reset ));
 sky130_fd_sc_hd__dfrtp_2 _516_ (.CLK(net15),
    .D(_079_),
    .RESET_B(_036_),
    .Q(\raven_spi.U1.addr[0] ));
 sky130_fd_sc_hd__dfrtp_2 _517_ (.CLK(net15),
    .D(_080_),
    .RESET_B(_037_),
